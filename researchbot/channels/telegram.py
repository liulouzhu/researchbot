...
from researchbot.config.paths import get_media_dir
from researchbot.config.schema import Base
from researchbot.security.network import validate_url_target
from researchbot.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm researchbot.\n\n"
